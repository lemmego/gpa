...
// KeyValueRepository is a legacy compatibility interface that combines basic KV operations.
// ⚠️ DEPRECATED - Use the specific interfaces above for new code! ⚠️
...
// NewAdvancedKVRepository creates a new advanced key-value repository.
// This is a convenience function for providers that implement the full interface.
func NewAdvancedKVRepository[T any](provider interface{}, client interface{}, keyPrefix string) AdvancedKeyValueRepository[T] {
	// This would be implemented by specific providers like Redis
	panic("NewAdvancedKVRepository must be implemented by specific providers")
}